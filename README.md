...
# Full Website Recorder and Replayer

**Ever had a website with premium content, on an account that about to expire ?**
Ever wanted to save forever this website content but the website is full of **ajax** things ?

**In this cases traditional website copiers wont work .**


**This Full Website Recorder and Replayer allows you to record any page you browse and later re play what you recorded exactly like the first time** .

This open source recorder is from my opinion very particular becasue it is even able to record Ajax Calls..

**But you have to browse the website by yourself**

(Curently no auto crawler is present because ajax calls are most of the time result of click events or javascript)
...
This Full Website Recorder and Replayer is an open source software that allows you to record any single page or ressource while you browse on website, and later re browse the pages you recorded exactly like the first time.

This recorder particular becasue it is even able to record Ajax Calls.
